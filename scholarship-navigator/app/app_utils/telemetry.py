...
def setup_telemetry() -> str | None:
    ...
    # Enable telemetry only if Google GenAI is configured to use Vertex AI
    use_vertex = os.environ.get("GOOGLE_GENAI_USE_VERTEXAI", "true").lower() in ("true", "1")
    os.environ.setdefault("GOOGLE_CLOUD_AGENT_ENGINE_ENABLE_TELEMETRY", "true" if use_vertex else "false")
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=scholarship-navigator,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        logging.warning(f"Bypassing Agent Engine telemetry initialization due to missing GCP credentials: {e}")
